...
function buildFormState(webinar) {
  ...
  return {
    ...
    scheduledStart: toDateTimeLocal(webinar?.scheduled_start),
              ...
              <div className="space-y-6">
                ...
                <div className="flex gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    {isEditing ? (
                      <p className="font-semibold text-on-surface text-sm">End time will be saved 1 hour after the selected start time.</p>
                    ) : (
