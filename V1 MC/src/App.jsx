...
function App() {
  ...
  useEffect(() => {
    ...
    // Guards against a stale/invalid refresh token wedging getSession() forever
    // (e.g. supabase-js navigator-lock contention after a crashed prior session).
    const sessionWatchdog = setTimeout(() => {
      console.warn("getSession() timed out; clearing stale auth state.");
