...
export default function ProfilePreview({ session }) {
  ...
  const [profileData, setProfileData] = useState({
    full_name: '', headline: '', bio: '', experience: [], skills: [], avatar_url: ''
  });
            ...
            <div className="md:col-span-2 space-y-8">
                ...
                <section className="bg-surface-container-lowest p-8 rounded-2xl shadow-sm border border-outline-variant/10 relative overflow-hidden group">
                    ...
                    <div className="relative z-10 flex items-start gap-4">
                        <div className="w-12 h-12 bg-primary/10 text-primary rounded-full flex items-center justify-center flex-shrink-0 mt-1 overflow-hidden">
